...
POSITIVE_TWEET_TRUMP = ['#trumpnight', '#trumpolympics', '#trumpforpresident', '#teamtrumppa', '#gotrump', '#lovetrump', '#godblesstrump', '#trumpiswithus', '#usafortrump', '#trump2016',
                        '#takebackamerica', '#trumpforpresident2016', '#trumpcare', '#trump4president', '#trumpcares', '#trump16', '#thedonald', '#trumpwillwin', '#deplorablesfortrump',
                        '#great', '#best', '#powerful', '#draintheswamp', '#saveusa', '#trumprally', '#hilaryforprison', '#hillary4prison2016', '#hillaryforjail', '#hillarysucks',
                        '#neverclinton', '#nevereverhillary', '#neverhillaryclinton', '#nomoreclintons', '#crookedclinton']

NEGATIVE_TWEET_TRUMP = ['#clinton2016', '#voteclinton', '#votehillaryclinton', '#hillaryforpresident', '#hillaryforamerica', '#hillaryclintonforpresident', '#hillaryclinton2016',
                        '#hillaryclinton', '#hiliary', '#hillary', '#hillary2016', '#hilaryclinton', '#fuckdonaldtrump', '#sexualpreditor', '#notmypresident', '#rapisttrump',
                        '#cowardlytrump', '#racisttrump', '#dangerousdonald', '#fuckyoutrump', '#nevertrumpers', '#predator']


NEGATIVE_FINANCE_TWEET = NEGATIVE_FINANCE + ['bearish', 'sell', 'bear', 'downside', 'short', 'breakdown', 'agains', 'bad', 'fall', 'down', 'worried', 'crash', 'ugly', 'wrong', 'selling', 'scare']
POSITIVE_FINANCE_TWEET = NEGATIVE_FINANCE + ['good', 'higher', 'healthy', 'bottom', 'hold', 'bullish', 'bull', 'high', 'great', 'long', 'solid', 'up', 'upside', 'above', 'buy', 'impressed', 'impressive']


def finance_tweet_seeds():
    logger.info('finance_tweet_seeds')
    return POSITIVE_FINANCE_TWEET, NEGATIVE_FINANCE_TWEET


def trump_seeds():
    logger.info('trump_seeds')
    return POSITIVE_TWEET_TRUMP, NEGATIVE_TWEET_TRUMP
